...
export default function ConfiguracionInicialWizard() {
        ...
        <div>
          <div className="flex items-center gap-3 mb-2">
            <Button
              variant="ghost"
              size="icon"
              onClick={() => navigate('/proveedor/configuracion')}
            ...
            <CardContent className="p-8 space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-4 rounded-lg bg-success/10 border border-success/20">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-medium text-success">¡Casi listo!</p>
                        <p className="text-sm text-success/80 mt-1">
                          Estás a un paso de completar la configuración inicial de tu cuenta.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="flex items-center justify-between pt-6 border-t">
                ...
                {etapaActual < ETAPAS.length ? (
                  ...
                  <Button onClick={finalizarConfiguracion} className="gap-2">
