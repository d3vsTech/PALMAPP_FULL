...
/**
 * Config de Vite. Las variables del `.env` que necesita el proxy del dev
 * server NO están en `process.env` automáticamente — hay que cargarlas con
 * `loadEnv(mode, cwd, 'VITE_')`. Por eso el callback recibe `mode`.
 */
