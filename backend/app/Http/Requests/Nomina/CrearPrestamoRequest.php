...
class CrearPrestamoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'inicio_anio'     => ['required', 'integer', 'min:2020', 'max:2099'],
            'inicio_mes'      => ['required', 'integer', 'between:1,12'],
            'inicio_quincena' => [$quincenal ? 'required' : 'nullable', 'integer', 'in:1,2'],
    ...
    protected function failedAuthorization(): void
    {
        throw new HttpResponseException(response()->json([
            'message' => 'No tienes permisos para registrar préstamos',
