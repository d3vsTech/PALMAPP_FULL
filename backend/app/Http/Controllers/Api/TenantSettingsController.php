...
class TenantSettingsController extends Controller
{
    ...
    /**
     * GET /api/v1/tenant/configuracion/info-empresa
     *
     * Retorna los datos actuales de la empresa (tenant actual).
     * Permiso requerido: configuracion.editar
     */
    public function showInfoEmpresa(): JsonResponse
    {
        try {
            ...
            Log::error('Error al obtener datos de info empresa: ' . $e->getMessage());
            return response()->json([
    ...
    /**
     * PUT /api/v1/tenant/configuracion/info-empresa
     * PUT /api/v1/tenant/configuracion/finca (alias legacy)
     *
    ...
    public function updateFinca(Request $request): JsonResponse
    {
        try {
            $request->validate([
                ...
                'actividad_economica'    => 'sometimes|nullable|string|max:200',
                // Representante Legal
                'representante_nombre'   => 'sometimes|nullable|string|max:200',
                'representante_cedula'   => 'sometimes|nullable|string|max:20',
                'representante_cargo'    => 'sometimes|nullable|string|max:100',
                ...
                'telefono_fijo'          => 'sometimes|nullable|string|max:20',
                'sitio_web'              => 'sometimes|nullable|string|max:200',
                // Logo
                ...
                'actividad_economica.max'   => 'La actividad económica no puede exceder 200 caracteres',
                'representante_nombre.max'  => 'El nombre del representante no puede exceder 200 caracteres',
                'representante_cedula.max'  => 'La cédula del representante no puede exceder 20 caracteres',
                'representante_cargo.max'   => 'El cargo del representante no puede exceder 100 caracteres',
                'correo_contacto.email'     => 'El correo de contacto debe ser válido',
                'telefono.max'              => 'El celular no puede exceder 20 caracteres',
                'telefono_fijo.max'         => 'El teléfono fijo no puede exceder 20 caracteres',
                'sitio_web.max'             => 'El sitio web no puede exceder 200 caracteres',
    ...
    private function formatTenantData(Tenant $tenant): array
    {
        return [
            ...
            'representante_nombre'   => $tenant->representante_nombre,
            'representante_cedula'   => $tenant->representante_cedula,
            'representante_cargo'    => $tenant->representante_cargo,
