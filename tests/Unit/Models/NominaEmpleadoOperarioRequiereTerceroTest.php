...
class NominaEmpleadoOperarioRequiereTerceroTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_operario_con_tercero_id_se_persiste(): void
    {
        $ids = $this->crearBase();
    ...
    public function test_operario_sin_tercero_id_viola_constraint(): void
    {
        $ids = $this->crearBase();
    ...
    public function test_empleado_sin_tercero_id_se_persiste(): void
    {
        $ids = $this->crearBase();
